...
import  ContextType  from '../context/pseudoContext';
import {
  StyleSheet,
  Text,
  View,
...
import { ContextType, ContextType, ContextType } from "../types/contextType";
...
export const Home: FC<Props> = () => {
  ...
  const { savePseudo } = useContext(PseudoContext) typeof contextType;
